...
FLEET_MENU = (950, 180, 70, 30)
FLEET_COM = (1640, 150, 120, 40)
WARP_TO_FLEET_COM = (1730, 90, 120, 40)
...
DREEL_1 = (1565, 510, 30, 30)
DREEL_2 = (1620, 510, 30, 30)
DREEL_3 = (1680, 510, 30, 30)
WARP_CHECK_DRONE = (1675, 455, 30, 30)
DRONE_2 = (1730, 455, 30, 30)
INTERA_1 = (1730, 510, 30, 30)
INTERA_2 = (1780, 510, 30, 30)
...
OVER_BUTTON = (1840, 320, 20, 20)

if __name__ == '__main__':
    import pyautogui

    img = pyautogui.screenshot(region=WARP_TO_FLEET_COM)
    img.show('test')
